...
public class Universidade implements Serializable {
	...
	private void gerarPad(Saida output) throws IOException {
		int tHSemanais;
		int tHSemestrais;
		output.abrirArquivoParaEscrita(Saida.CAMINHO_SAIDA+"1-pad.csv");
		try {
	...
	private void gerarRha(Saida output) throws IOException {
		output.abrirArquivoParaEscrita(Saida.CAMINHO_SAIDA+"2-rha.csv");
		try {
	...
	private void gerarAlocacao(Saida output) throws IOException {
		output.abrirArquivoParaEscrita(Saida.CAMINHO_SAIDA+"3-alocacao.csv");
		try {
	...
	private void gerarPpg(Saida output) throws IOException {
		output.abrirArquivoParaEscrita(Saida.CAMINHO_SAIDA+"4-ppg.csv");
		try {
